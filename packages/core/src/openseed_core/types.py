...
class PipelineState(TypedDict):
    ...
    intake_analysis: dict[str, Any]  # INTENT, COMPLEXITY, REQUIREMENTS, APPROACH, etc.

    # ── Clarification (intake asks questions before pipeline runs) ────────
    clarification_questions: list[str]  # Questions generated by intake
    clarification_answers: list[str]  # User's answers to those questions
